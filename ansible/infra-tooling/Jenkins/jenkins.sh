...
sed -i 's/NL_WEB_LOGIN_PLACEHOLDER/' "$NL_WEB_LOGIN"'/' $JENKINS_HOME/config.xml
sed -i 's/NL_WEB_LOGIN_PLACEHOLDER/' "$NL_WEB_LOGIN"'/' $JENKINS_HOME/org.jenkinsci.plugins.neoload.integration.NeoGlobalConfig.xml
